...
+ is it fine to pool together life expectancy estimates (e.g., mean within a decile is pooled mean of percentiles)?
...
ggsave('appendix_1c.png', height=6, width=8.5, dpi=600)
```
